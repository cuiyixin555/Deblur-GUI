...
class DataGrid_User(QWidget):
    ...
    def getTotalRecordCount(self):
        self.queryModel.setQuery("select * from user")
    ...
    def recordQuery(self, limitIndex):
        szQuery=("select * from user limit %d,%d" % (limitIndex, self.PageRecordCount))
